    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 w-11/12 mx-auto mt-8 mb-10">
        {slides.map((slide) => (
          <div
            key={slide.id}
            className="relative bg-cover bg-center h-[350px] sm:h-[400px] md:h-[450px] rounded-lg overflow-hidden transition-all transform duration-300 hover:scale-105 hover:shadow-lg"
            style={{
